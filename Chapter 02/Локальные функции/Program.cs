void Compare1(int[] numbers1, int[] numbers2)
{
    int numbers1Sum = 0;
    int numbers2Sum = 0;
...
int[] numCompare1 = { 1, 2, 3 };
int[] numCompare2 = { 3, 4, 5, 6, 7 };
Compare1(numCompare1, numCompare2);
Compare2(numCompare1, numCompare2);
